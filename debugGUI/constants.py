...
DEFAULT_GEOMETRY = f'{MINIMUM_WIDTH}x{MINIMUM_HEIGHT}+0+0'
DEFAULT_ALIAS_GEOMETRY = f'{MINIMUM_WIDTH - 60}x{int(MINIMUM_HEIGHT*2/3)}+30+30'
DEFAULT_ALIAS_SASH = [MINIMUM_WIDTH // 4, 1]
DEFAULT_FINDER_GEOMETRY = f'{MINIMUM_WIDTH - 60}x{int(MINIMUM_HEIGHT)}+30+30'
...
optionsAreInts = ['ConsolePort', 'Port', 'EndPort', 'MaxHistoryCmds',	# Settings
	   ...
	   'Size', 				# Font
	   'FindSashOffset','FindContextLines']

optionsAreLists = ['ToolTips',				# Settings
	'AliasSashOffset', 'FindPaths', 'FindTypes',	# History
	'FindExcls', 'FindSearches', 'SearchTerms']
...
defaultConfig = OrderedDict((
	...
	('History', OrderedDict((			# window/sash positions, listbox histories
		...
		('AliasSashOffset', 	DEFAULT_ALIAS_SASH),
